...
public class SetView extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3150087814271280115L;
	...
	private void initScreen(JFrame parent) {
		...
		panel.add(sourceLabel, new GridBagConstraints(0, 1, 1, 1, 0, 0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						0, 0, 5, 5), 0, 0));
		panel.add(new JScrollPane(sourceList), new GridBagConstraints(0, 2, 1,
		...
		panel.add(destLabel, new GridBagConstraints(2, 1, 1, 1, 0, 0,
				GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
						0, 0, 5, 0), 0, 0));
		panel.add(new JScrollPane(destList), new GridBagConstraints(2, 2, 1, 5,
		...
		btnCancel = new JButton(MainFrame.getInstance().getActionManager()
				.getSetCancel());
		...
		btnSave = new JButton(MainFrame.getInstance().getActionManager()
				.getSetSubmit());
